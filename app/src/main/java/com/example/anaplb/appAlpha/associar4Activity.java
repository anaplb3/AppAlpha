...
public class associar4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_associar4);
        ...
        AppCompatImageView imagemApp = findViewById(R.id.imageView6);
        imagemApp.setImageResource(this.ids.get(numeroAleatorio));
    }

    public void escolhaA(View view) {
        Button botao = findViewById(R.id.button33);
    ...
    public void escolhaE(View view) {
        Button botao = findViewById(R.id.button34);
        TestandoBotoes button = new TestandoBotoes(botao, this.letras, this.ids);
    ...
    public void escolhaI(View view) {
        Button botao = findViewById(R.id.button35);
        TestandoBotoes button = new TestandoBotoes(botao, this.letras, this.ids);
    ...
    public void escolhaO(View view) {
        Button botao = findViewById(R.id.button36);
        TestandoBotoes button = new TestandoBotoes(botao, this.letras, this.ids);
    ...
    public void escolhaU(View view) {
        Button botao = findViewById(R.id.button37);
        TestandoBotoes button = new TestandoBotoes(botao, this.letras, this.ids);
    ...
    public void escolhendoImagem(String escolhaUsuario) {
        ...
        TextView textinho = findViewById(R.id.textView13);
        ...
        Intent intent = new Intent(getApplicationContext(), associar5Activity.class);
