...
public class associar3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_associar3);
        ...
        AppCompatImageView imagemApp = findViewById(R.id.imageView4);
        imagemApp.setImageResource(this.ids.get(numeroAleatorio));
    }

    public void escolhaA(View view) {
        Button botao = findViewById(R.id.button28);
    ...
    public void escolhaE(View view) {
        Button botao = findViewById(R.id.button29);
        TestandoBotoes button = new TestandoBotoes(botao, this.letras, this.ids);
    ...
    public void escolhaI(View view) {
        Button botao = findViewById(R.id.button30);
        TestandoBotoes button = new TestandoBotoes(botao, this.letras, this.ids);
    ...
    public void escolhaO(View view) {
        Button botao = findViewById(R.id.button31);
        TestandoBotoes button = new TestandoBotoes(botao, this.letras, this.ids);
    ...
    public void escolhaU(View view) {
        Button botao = findViewById(R.id.button32);
        TestandoBotoes button = new TestandoBotoes(botao, this.letras, this.ids);
    ...
    public void escolhendoImagem(String escolhaUsuario) {
        ...
        TextView textinho = findViewById(R.id.textView12);
        ...
        Intent intent = new Intent(getApplicationContext(), associar4Activity.class);
